                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ">
                       <li class="nav-item pl-4">
                        <a href="{{"/whistlist"}}" class="nav-link">
                            <i class="fas fa-heart text-primary"></i>
                            @if(auth()->user())
                            <span class="badge text-muted">{{count(auth()->user()->wishlist)}}</span>
                            @endif
                        </a>
                       </li>
                       <li class="nav-item pl-3">
                        <a href="{{"/cart"}}" class="nav-link">
                            ...
                            <span class="badge text-muted">{{session('cart') ? count(session('cart')) : 0}}</span>
                        </a>
                       </li>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                &copy; <a class="text-dark font-weight-semi-bold" href="#">Thinzar</a>. All Rights Reserved.
            </p>
        </div>
